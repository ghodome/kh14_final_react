                    ...
                    <div className="container my-4">
                        ...
                        <div className="row mt-4">
                            <div className="col text-center">
                                <button type="button" className="btn btn-dark rounded-0 w-25" onClick={() => navigate("/member/update")}>
                                    수정하기
                                </button>
                                <button type="button" className="btn btn-secondary ms-5 rounded-0 w-25" onClick={() => navigate("/member/pwChange")}>
                                    비밀번호 변경
                                </button>
                                <button type="button" className="btn btn-light ms-5 rounded-0 w-25" onClick={handleDelete}>
                                    탈퇴하기
                                </button>
                            </div>
                        </div>
